...
The action receives a unified diff file, extracts added lines with file paths and new-file line numbers, scans those added lines for configured Unicode code points, emits GitHub annotations, sets summary outputs, and fails when required.
